...
//			for (String trainRoutes : routes) {
			// if(trainRoutes.getRoutes().get(0).equalsIgnoreCase(from) &&
			// train2.getRoutes().get(routes.size()-1).equalsIgnoreCase(to))
...
//					if (routes.get(i).equals IgnoreCase(from))
//						fromIndex = i;
